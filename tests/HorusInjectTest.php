...
class HorusInjectTest extends HorusTestCase
{
    ...
    public function testInjectXml(): void
    {
        $injector = new HorusInjector('injectorbusinessid', null, self::$tracer);
        $json = '{"template": "broadcast_camt053.xml","repeat":"1",' .
            '"sourcetype":"application/xml","destinationcontent":"application/xml"}';
    ...
    public function testInjectJson(): void
    {
        $injector = new HorusInjector('injectorbusinessid', null, self::$tracer);
        $json = '{"template": "position_msg_response.json","repeat":"1",' .
            '"sourcetype":"application/json","destinationcontent":"application/json",' .
            '"attr":{"msgref":"123456","ipsystem":"AAA","ipparticipant":"BBB","ipaccountid":"CCC"}}';
        $ret = $injector->doInject($json, '', self::$rootSpan);
        ...
        $this::assertTrue(
            ...
            'doInject returns json content-type.'
        );
    ...
    public function testConvert(): void
    {
        $injector = new HorusInjector('injectorbusinessid', null, self::$tracer);
        $json = '{"template": "broadcast_camt053.xml","repeat":"1",' .
            '"sourcetype":"application/xml","destinationcontent":"application/json"}';
        $ret = $injector->doInject($json, '', self::$rootSpan);
        $this::assertTrue(
            in_array(
            ...
            'doInject returns xml content-type'
        );
